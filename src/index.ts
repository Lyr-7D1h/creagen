...
export { CircleOptions } from './Canvas/Circle'
export { ArcOptions } from './Canvas/Arc'
export { ImageOptions } from './Canvas/Image'
export { PathOptions } from './Canvas/Path'
export { RectangleOptions } from './Canvas/Rectangle'
